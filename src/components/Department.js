      ...
      <div className='department__wrapper'>
        ...
        <div className='department__container'>
          <div className='department__container-card'>
            ...
            {parcels.filter(parcel => parcel.Value >= 1000 && parcel.signedInsurance == "false").map((parcel, index) => (  
            <Parcel
              parcel={parcel}
          ...
          <div className='department__container-card'>
            ...
            {parcels.filter(parcel => parcel.Weight <= 1 && parcel.Value < 1000 || parcel.Weight <=1 && parcel.Value >= 1000 && parcel.signedInsurance == "true").map((parcel, index) => (   
            <Parcel
              parcel={parcel}
          ...
          <div className='department__container-card'>
            ...
            {parcels.filter(parcel => parcel.Weight <= 10 && parcel.Weight > 1 && parcel.Value < 1000 || parcel.Weight <=10 && parcel.Weight > 1 && parcel.Value >= 1000 && parcel.signedInsurance == "true").map((parcel, index) => (    
            <Parcel
              parcel={parcel}
              signParcel={signParcelOther}
              index = {parcel.id}
          ...
          <div className='department__container-card'>
            ...
            {parcels.filter(parcel => parcel.Weight > 10 && parcel.Value < 1000 || parcel.Weight > 10 && parcel.Value >= 1000 && parcel.signedInsurance == "true").map((parcel, index) => (  
            <Parcel
              parcel={parcel}
              signParcel={signParcelOther}
              index = {parcel.id}
